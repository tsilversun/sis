...
<div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                ...
                <a href="Users.html" class="list-group-item list-group-item-action bg-transparent second-text fw-bold active">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid row my-5">
                <div class="input-group rounded row">
                    <h3 class="fs-4 mb-3 col">List of Users</h3>
                ...
                <div class="container justify-content-sm-start my-2 mb-2">
                    <a class="btn btn-outline-primary float-end"  data-bs-toggle="modal" data-bs-target="#user">Create New</a>
                </div>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                          <li><a class="dropdown-item"  data-bs-toggle="modal" data-bs-target="#user">Edit</a></li>
                                          <li><a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#DelUser">Delete</a></li>
                                        </ul>
                                      </div>
                                </td>                         
                            </tr>
